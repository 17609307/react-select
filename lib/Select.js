...
var Select = _react2['default'].createClass({
	...
	propTypes: {
		...
		disableMenuBlur: _react2['default'].PropTypes.bool, // Custom: Show the menu still on input blur if true
		...
		openOnLoad: _react2['default'].PropTypes.bool, // opens menu after component load
	...
	selectValue: function selectValue(value, event) {
		this.hasScrolledToOption = false;
		if (this.props.multi) {
			this.addValue(value);
			this.setState({
